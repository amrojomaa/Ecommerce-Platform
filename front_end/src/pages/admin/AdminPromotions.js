      ...
      <form className="adm-promo-form" onSubmit={submitPromotion}>
        <div className="adm-promo-form-grid adm-promo-form-grid--3">
          <div className="adm-promo-field">
            <label htmlFor="promo-name">{tUi('ui.pages.admin.adminPromotions.promotionName_df0623c346')}</label>
            <input
              id="promo-name"
              type="text"
              value={form.name}
          ...
          <div className="adm-promo-field">
            <label htmlFor="promo-target-type">{tUi('ui.pages.admin.adminPromotions.targetType_fefe0c8c35')}</label>
            <select
            ...
            <input
              ...
              placeholder={
                form.target_type === 'amount'
                  ? tUi('ui.pages.admin.adminPromotions.eG250_423fea402b')
                  : tUi('ui.pages.admin.adminPromotions.eG5_983cd1bfe4')
              }
            />
          </div>
        </div>
        ...
        <div className="adm-promo-form-grid">
          <div className="adm-promo-field">
            <label htmlFor="promo-discount-type">{tUi('ui.pages.admin.adminPromotions.discountType_01c9cdd79c')}</label>
            <select
            ...
            <input
              ...
              placeholder={
                form.discount_type === 'percentage'
                  ? tUi('ui.pages.admin.adminPromotions.eG10_fea6ad1c95')
                  : tUi('ui.pages.admin.adminPromotions.eG50_6ed362485d')
              }
            />
          </div>
        </div>
        ...
        <div className="adm-promo-filter-box">
          <p className="adm-promo-filter-title">
            {tUi('ui.pages.admin.adminPromotions.select_f53d6e97bb')} {activeFilterMeta.entityPlural} to{' '}
            {activeFilterMeta.modeLabel}
          </p>

          <div className="adm-promo-form-grid">
            <div className="adm-promo-field">
              <label htmlFor="promo-option-search">
                {tUi('ui.pages.admin.adminPromotions.search_3ef2a27f22')} {activeFilterMeta.entityPlural}
              </label>
              <input
                ...
                placeholder={tUi('ui.pages.admin.adminPromotions.searchValue_2f91ef0392', {
                  value0: activeFilterMeta.entityPlural,
                })}
              />
            </div>
              ...
              >
                <option value="">
                  {availableOptions.length
                    ? tUi('ui.pages.admin.adminPromotions.selectValue_7f5abf4ca9', {
                        value0: activeFilterMeta.entitySingular,
                      })
                    : tUi('ui.pages.admin.adminPromotions.noMoreValue_5e45337c69', {
                        value0: activeFilterMeta.entityPlural,
                      })}
                </option>
          ...
          <div className="adm-promo-options-panel">
            {loading && rawOptions.length === 0 ? (
              <p className="adm-promo-empty-hint">
                {tUi('ui.pages.admin.adminPromotions.loading_43f08352f4')}
                {activeFilterMeta.entityPlural}...
              </p>
            ) : form.filter_values.length === 0 ? (
              <p className="adm-promo-empty-hint">
                No {activeFilterMeta.entityPlural}
                {tUi('ui.pages.admin.adminPromotions.selectedYet_4bd13349ac')}
              </p>
            ) : (
        ...
        <div className="adm-promo-form-actions">
          ...
          <button type="submit" className="adm-btn-primary" disabled={submitting}>
            {submitting
              ? tUi('ui.pages.admin.adminPromotions.saving_b9b5b0297e')
              : editingId
                ? tUi('ui.pages.admin.adminPromotions.updatePromotion_2382525a9a')
            ...
            <div className="adm-promo-list">
              {promotions.map((promotion) => (
                ...
                >
                  ...
                  <p className="adm-promo-card-meta">
                    {tUi('ui.pages.admin.adminPromotions.filter_0e0778005a')}{' '}
                    <strong>{FILTER_LABELS[promotion.filter_type]}</strong> ({promotion.filter_values.length}{' '}
                    {tUi('ui.pages.admin.adminPromotions.selected_17a02c10f8')})
                  </p>
